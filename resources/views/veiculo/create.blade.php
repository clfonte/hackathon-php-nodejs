    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#"><b>Novos</b></a>
          </li>

          <li class="nav-item">
            <a class="nav-link active" href=""><b>Seminovos</b></a>
          </li>
    ...
    <div class="row mb-3">
      <form action="{{ route('registrar_veiculo') }}" method="POST">
        ...
        <div class="col-12 col-md-8">
          ...
          <input type="text" id="modelo" name="modelo" class="form-control" alt="Modelo"
          required data-parsley-required-message="Preencha o nome do login"placeholder="Modelo">
        </div>
        ...
        <div class="col-12 col-md-4">
          ...
          required data-parsley-required-message="Ano modelo não pode ficar me branco" placeholder="Informe o Ano do Modelo">
        </div>

      {{-- LINHA 2 --}}
      <div class="col-12 col-md-4 mt-3">
          <label for="anoFabricacao"><b>Ano de Fabricação</b></label>
          <input type="text" class="form-control" autocomplete="off" id="anoFabricacao" name="anoFabricacao" 
          required data-parsley-required-message="Ano de fabricação não pode estar em branco" placeholder="Informe o ano de fabricação">
      </div>
  
        <div class="col-12 col-md-4 mt-3">
          <label for="valor"><b>Valor</b></label>
          <input type="text" class="form-control" autocomplete="off" id="valor" name="valor" 
          required data-parsley-required-message="Valor não pode estar em branco" placeholder="R$">
        </div>
