...
<body>
    <div class="container">
        <div class="row mb-3">
            <form action="{{ route('editar_veiculo', ['id' => $veiculo->id]) }}" enctype="multipart/form-data" method="POST">
                <div class="row mb-3">
                    @csrf
                    <h1 class="mt-3 text-info">Edição De Veículos</h1>

                    {{-- LINHA 1 --}}
                    <div class="col-12 col-md-8">
                        <label for="modelo"><b>Modelo</b></label>
                        <input type="text" id="modelo" name="modelo" value="{{$veiculo->modelo}}" class="form-control" alt="Modelo" required
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="anoModelo" class="form-control" value="{{$veiculo->anoModelo}}" autocomplete="off" id="anoModelo" name="anoModelo"
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <input type="text" class="form-control" value="{{$veiculo->anoFabricacao}}" autocomplete="off" id="anoFabricacao"
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <input type="text" class="form-control" value="{{$veiculo->valor}}" autocomplete="off" id="valor" name="valor" required
                            data-parsley-required-message="Valor não pode estar em branco" placeholder="R$">
                    </div>

                    <div class="col-12 col-md-4 mt-3">
                        <label for="tipo"><b>Tipo</b> </label>
                        <select class="form-select" value="{{$veiculo->tipo}}" name="tipo" id="tipo">
                            <option value=""></option>
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <select class="form-select" value="{{$veiculo->cor_id}}" name="cor_id" id="cor_id">
                            @foreach ($cor as $c)
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <select class="form-select" value="{{$veiculo->marca_id}}" name="marca_id" id="marca_id">
                            @foreach ($marca as $m)
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <select class="form-select" value="{{$veiculo->usuario_id}}" name="usuario_id" id="usuario_id">
                    ...
                    <div class="col-12 col-md-4 mt-3">
                        ...
                        <textarea type="text" id="descricao" value="{{$veiculo->descricao}}" name="descricao" class="form-control"
                    ...
                    <input class="form-control" type="file" value="{{veiculo->modelo}}" name="fotoDestaque" id="formFile">
                    </div> --}}


                    {{-- <div class="col-auto">
                    <label class="visually-hidden" for="autoSizingSelect">Preference</label>
                    <select class="form-select" value="{{veiculo->modelo}}" name="usuario_id" id="autoSizingSelect">
                        <option class="Disabled">Selecione o usuario...</option>
                    </select>
                    </div> --}}
                </div>
