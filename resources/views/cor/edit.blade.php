...
<body>
    ...
    <div class="container">
        <form action="{{ route('editar_cor', ['id' => $cor->id]) }}" method="POST">
            ...
            @csrf
            <h3 class="mt-3 text-info">Editar Cor</h3>
            ...
            <div class="col-12 col-md-8">
                ...
                <input type="text" id="cor" name="cor" value="{{ $cor->cor }}" class="form-control"
                    placeholder="Cor">
            </div>

            <button type="submit" class="btn btn-outline-info mt-3" href="/cor/listar">Salvar</button>

            <a class="btn btn-outline-danger mt-3" href="/cor/listar">Cancelar</a>
        </form>
    </div>
